...
def main():
    ...
    # Spark 读取用：带 s3://
    S3_PATH_PREFIX = "s3://cloud-based-distributed-system-bucket-project"
    ...
    train_df = spark.read.csv(f"{S3_PATH_PREFIX}/dataset_train.csv", header=True, sep="\t", quote="")
    test_df = spark.read.csv(f"{S3_PATH_PREFIX}/dataset_test.csv", header=True, sep="\t", quote="")
    ...
    result_text = (
        "========================================\n"
        " Big Data Task Evaluation Results \n"
        "========================================\n"
